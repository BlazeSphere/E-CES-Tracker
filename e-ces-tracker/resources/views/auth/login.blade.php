<x-layouts.app>
    <div class="min-h-screen flex flex-col bg-gradient-to-b from-[#15803d] to-[#e9f0fa] relative overflow-hidden">
        ...
        <div class="absolute inset-0 z-0 pointer-events-none">
             <img src="{{ asset('images/login-bg.png') }}" class="w-full h-full object-cover opacity-80 mix-blend-overlay" alt="Background">
        </div>

        <!-- Header -->
        <header class="relative z-10 flex items-center p-4 px-10">
            <img src="{{ asset('images/logo.png') }}" class="w-16 h-16 mr-4" alt="DWCC Logo">
            <div>
            ...
            <div class="bg-[#1b8c00] bg-opacity-90 rounded-xl p-12 w-full max-w-md shadow-2xl flex flex-col items-center">
                <div class="mb-6 flex flex-col items-center">
                    <div class="w-20 h-20 mb-4 flex items-center justify-center">
                        <img src="{{ asset('images/logo.png') }}" class="w-full h-full object-contain" alt="App Logo">
                    </div>
        ...
        <footer class="relative z-10 bg-[#1b8c00] text-white p-10 mt-auto">
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-center md:text-left">
                ...
                <div class="flex flex-col items-center lg:items-start">
                    <img src="{{ asset('images/logo.png') }}" class="w-32 h-32 mb-4 object-contain" alt="DWCC Logo Large">
