...
return [
    ...
    */
    ...
    'node' => [
        'shape' => 'none', // This removes the ovals and makes it a clean table
        'margin' => 0,
        'fontname' => 'Segoe UI',
        'fontsize' => '12',
    ],
    ...
    'edge' => [
        'color' => '#006400', // Using a dark green (Divine Word color)
        'fontname' => 'Segoe UI',
        'fontsize' => '10',
        'arrowsize' => 0.8,
        'curved' => false, // Straight lines look more professional for ERDs
    ],
